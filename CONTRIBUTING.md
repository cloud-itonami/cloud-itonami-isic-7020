...
`cloud-itonami-isic-7020` accepts contributions to the OSS blueprint, capability
...
- Keep issuing a recommendation/deliverable to a client behind the Consulting Engagement Governor.
